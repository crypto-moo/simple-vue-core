...
function createRenderer(options) {
    ...
    function processFragment(oldVNode, vnode, el, parent) {
        mountChildren(oldVNode, vnode.children, el, parent);
    }
    ...
    function mountElement(oldVNode, vnode, rootContainer, parent) {
        ...
        if (vnode.shapeFlag & 4 /* ShapeFlags.TEXT_CHILDREN */) {
            ...
            mountChildren(oldVNode, vnode.children, node, parent);
        }
        if (vnode.props) {
    ...
    function mountChildren(oldVNode, children, node, parent) {
