...
function createRenderer(options) {
    ...
    function patchChildren(oldVNode, vnode, el, parent) {
        var oldShapeFlag = oldVNode.shapeFlag, oldC = oldVNode.children;
        var shapeFlag = vnode.shapeFlag, c = vnode.children;
