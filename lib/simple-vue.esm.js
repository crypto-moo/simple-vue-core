...
function createRenderer(options) {
    ...
    function patch(vnode, rootContainer, parent) {
    ...
    function processText(vnode, parent) {
        var el = document.createTextNode(vnode.children);
        vnode.$el = el;
        parent.appendChild(el);
    }
    function processFragment(vnode, el, parent) {
        mountChildren(vnode.children, el, parent);
    }
    function processComponent(vnode, rootContainer, parent) {
        mountComponent(vnode, rootContainer, parent);
    }
    function mountComponent(vnode, rootContainer, parent) {
    ...
    function processElement(vnode, rootContainer, parent) {
    ...
    function mountElement(vnode, rootContainer, parent) {
        ...
        var node = createElement(vnode.type);
        vnode.$el = node;
...
function createApp(rootComponent, customRender) {
    return {
